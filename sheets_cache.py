...
def init_db() -> None:
    ...
    with _connection() as conn:
        ...
        # Кто отправил состав в общий чат. Это единственное сообщение бота,
        # которое видит вся команда, и вопрос «бот сам или человек?» встал в
        # первый же раз, когда состав появился в чате.
        _ensure_column(conn, "game_roster_state", "posted_by", "TEXT NOT NULL", "''")
